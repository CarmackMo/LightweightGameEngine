...
{
	class cMultiplayerGame final : public eae6320::Application::iApplication, public eae6320::cSingleton<cMultiplayerGame>
	{
	...
	private:
		...
		std::shared_ptr<eae6320::Graphics::cEffect> m_effect_animate;
		std::shared_ptr<eae6320::Graphics::cEffect> m_effect_standard;
		...
		eae6320::cPhysicDebugObject m_colliderObject_AABB1;
		eae6320::cPhysicDebugObject m_colliderObject_AABB2;
		eae6320::cPhysicDebugObject m_colliderObject_AABB3;
		eae6320::cPhysicDebugObject m_colliderObject_AABB4;

		eae6320::cPhysicDebugObject m_colliderObject_sphere1;
		eae6320::cPhysicDebugObject m_colliderObject_sphere2;
		eae6320::cPhysicDebugObject m_colliderObject_sphere3;

		std::vector<eae6320::cPhysicDebugObject*> m_colliderObjectList;
